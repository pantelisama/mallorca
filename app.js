...
if(route&&map){drawRoute(currentDay);routeLayer.addTo(map);routeVisible=true;}\nconst oldWidget=document.querySelector(".route-widget");if(oldWidget)oldWidget.remove();if(stopWidget&&map){document.querySelector("#map").insertAdjacentHTML("beforeend",stopWidget);}
