...
const spots=[
  ...
  {by:"Pantelis",n:"Bibap",q:"Bibap, Palma, Mallorca, Spain",c:[39.572,2.649],cat:"food",day:"all",type:"Palma old town · Korean & Asian",rating:4.3,reviews:1656,price:"€20–30",hours:"Έως 22:30",photo:"https://www.traveltozero.com/es/explora/gastronomia/bi-bap-restaurante-palma",d:"Κορεάτικο και ασιατικό. Δοκίμασε το duck bibimbap."},
  ...
  {by:"Pantelis",n:"Roosevelvet Bakery",q:"Rosevelvet Bakery, Palma, Mallorca, Spain",c:[39.5707,2.6553],cat:"food",day:"all",type:"Arxiduc · bakery",d:"Bakery που φαίνεται να βρίσκεται κοντά στο Bar Rey Sancho. Έλεγξε το ωράριο πριν πας."},
